    ...
    <div class="col s12 m12 l12">
        <div class="card card card-default scrollspy">
            <div class="card-content">
                ...
                <?php endif; ?>
                <form class="col s12" id="add_user_form" method="post" action="<?php echo e(route('editUserPost', ['id'=>$user->id])); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="row">
                        ...
                        <div class="input-field col m4">
                            <select name="status" id="status">
                                ...
                                <option value="0" <?php if($user->active == 0): ?> selected <?php endif; ?>>Inactive</option>
                            </select>
                        ...
                        <div class="col m4">
                            ...
                            <select class="error browser-default" id="role" name="role" data-error=".errorTxt6">
                                <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($role->id); ?>" <?php if($user->role_id == $role->id): ?> selected <?php endif; ?>><?php echo e($role->display_name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\xampp\htdocs\Laravel\resources\views/users/edit_user.blade.php ENDPATH**/ ?>