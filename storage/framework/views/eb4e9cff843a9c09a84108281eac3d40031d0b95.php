<form id="transaction" action="/gexpense/edit/<?php echo e($tr->id); ?>" method="post">
    <?php echo csrf_field(); ?>
...
</form><?php /**PATH G:\xampp\htdocs\Laravel\resources\views/expense/edit.blade.php ENDPATH**/ ?>