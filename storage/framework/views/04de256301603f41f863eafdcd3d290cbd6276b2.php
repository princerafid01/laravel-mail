        ...
        <ul class="collapsible collapsible-accordion" data-collapsible="accordion">
                        ...
                        <div class="row">
                            ...
                            <div class="col m6">
                                ...
                                <div class="input-field col m6">
                                    ...
                                    <label for="income1">Expense</label>
                                </div>
                                <div class="input-field col m6">
                                    <input id="income2" name="income2" type="number">
                                    <label for="income2">Expense</label>
                                </div>
                            </div>
            ...
            <li class="active">
                <div id="table_tab" class="collapsible-header light-blue light-blue-text text-lighten-5">
                    <i class="material-icons">money_off</i> Expense
                </div>
                <div class="collapsible-body light-blue lighten-5">
...
<?php $__env->startSection('other_java'); ?>
    <script>
      var DT = $('#page-length-option').DataTable({
          ...
          "order": [],
            "ajax": "/transactionList?type=expense",
            "columns": [
                {"data": "created_at"},
                {'data':'trip'},
                {'data':'detail'},
                    ...
                    render:function(a,n,e,s) {
                        return "<a class='dropdown-trigger' href='#' data-target='dropdown"+a+"'><i class='material-icons'>more_horiz</i></a>" +
                            "<ul id='dropdown"+a+"' class='dropdown-content'>" +
                                <?php if (\Entrust::can('expense_edit')) : ?> "<li><a class='remote' href='/transaction/edit/"+a+"'><i class='material-icons'>edit</i>Edit</a></li>" + <?php endif; // Entrust::can ?>
                                <?php if (\Entrust::can('expense_delete')) : ?> "<li><a onclick='confirm_delete(\"<?php echo e(route('transactionDelete',['id'=>''])); ?>/"+a+"\")'><i class='material-icons'>delete</i>Delete</a></li>" + <?php endif; // Entrust::can ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\xampp\htdocs\Laravel\resources\views/transaction/expense.blade.php ENDPATH**/ ?>