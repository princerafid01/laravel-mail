...
<head>
    ...
    <title>Forgot Password | <?php echo e(option('site_name')); ?></title>
                    ...
                    <form class="login-form" method="POST" action="<?php echo e(route('password.email')); ?>">
                        ...
                        <div class="row">
                            <div class="input-field col s12">
                                ...
                                <input id="email" type="email" value="<?php echo e(old('email')); ?>" name="email" required>
...
if (isset($messageCache)) { $message = $messageCache; }
                        ...
                        <div class="row">
                            <div class="input-field col s12">
                                <button type="submit" class="btn waves-effect waves-light border-round gradient-45deg-purple-deep-orange col s12 mb-1"><?php echo e(__('Send Password Reset Link')); ?></button>
                            </div>
                        </div>
                        <div class="row">
...
<?php /**PATH G:\xampp\htdocs\Laravel\resources\views/auth/passwords/email.blade.php ENDPATH**/ ?>