...
<head>
    ...
    <title>Welcome | <?php echo e(option('site_name')); ?></title>
        ...
        <div class="row">
            <div class="col s12">
                <div class="col s12 center-align">
                    <img src="<?php echo e(asset('assets/images/intro-app.png')); ?>" class="bg-image-404" alt="">
                    <h1 class="error-code m-0"><?php echo e(option('site_name')); ?></h1>
                    <a class="btn waves-effect waves-light green gradient-shadow mb-4" href="<?php echo e(route('login')); ?>">Login</a>
                </div>
            </div>
        </div>
    </div>
...
<?php /**PATH G:\xampp\htdocs\Laravel\resources\views/welcome.blade.php ENDPATH**/ ?>