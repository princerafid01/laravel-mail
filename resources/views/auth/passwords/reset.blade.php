...
<head>
    ...
    <title>Reset Password | {{option('site_name')}}</title>
                    ...
                    <form class="login-form" method="POST" action="{{ route('password.update') }}">
                        ...
                        <div class="row">
                            <div class="input-field col s12">
                                ...
                                <input id="email" type="email" value="{{ $email ?? old('email') }}" autocomplete="email" autofocus name="email" required>
                        ...
                        <div class="row">
                            <div class="input-field col s12">
                                <button type="submit" class="btn waves-effect waves-light border-round gradient-45deg-purple-deep-orange col s12 mb-1">{{ __('Reset Password') }}</button>
                            </div>
                        </div>
                        <div class="row">
