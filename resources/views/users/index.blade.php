                ...
                <div class="col s12">
                    <div class="card">
                        <div class="card-content">
                            ...
                            @permission('user_add') <a href="{{route('addUser')}}" class="waves-effect waves-light btn mb-1 float-right">
                                <i class="material-icons right">person_add</i> New User</a> @endpermission
                            <div class="row">
                                <div class="col s12">
                                    <table id="page-length-option" class="display DataTable stripe">
                                        ...
                                        @foreach($users as $user)
                                            <tr>
                                                ...
                                                <td>@if($user->active) <span class="badge new gradient-45deg-green-teal gradient-shadow" data-badge-caption="Active"></span> @else <span class="badge gradient-45deg-purple-deep-orange gradient-shadow" data-badge-caption="Inactive"></span> @endif</td>
                                                <td>{{$user->created_by->name}}</td>
                                                <td>@permission('user_edit') <a class="btn-floating waves-effect waves-light gradient-45deg-indigo-purple tooltipped"  data-position="top" data-tooltip="Edit" href="{{route('editUser', ['id'=>$user->id])}}"><i class="material-icons">edit</i></a> @endpermission</td>
                                            </tr>
                                            @endforeach
