        ...
        <ul class="collapsible collapsible-accordion" data-collapsible="accordion">
            <li>
                ...
                <div class="collapsible-body light-blue lighten-5">
                    <form id="filter_form" method="get" action="{{route('tripList')}}">
                        <div class="row">
...
@section('other_java')
                    ...
                    render:function(a,n,e,s) {
                        return "<a class='dropdown-trigger' href='#' data-target='dropdown"+a+"'><i class='material-icons'>more_horiz</i></a>" +
                            "<ul id='dropdown"+a+"' class='dropdown-content'>" +
                                @permission('expense_edit') "<li><a class='remote' href='/transaction/edit/"+a+"'><i class='material-icons'>edit</i>Edit</a></li>" + @endpermission
                                @permission('expense_delete') "<li><a onclick='confirm_delete(\"{{route('transactionDelete',['id'=>''])}}/"+a+"\")'><i class='material-icons'>delete</i>Delete</a></li>" + @endpermission
    ...
    $('#reset').on('click', function () {
      ...
      $(document).on('click','.transaction_link td:not(:last-child)', function () {
          ...
          var url = '{{route('transactionModal', ['id'=>''])}}/'+id;
